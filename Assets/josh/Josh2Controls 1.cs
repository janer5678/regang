...
//     version 1.7.0
//     from Assets/josh/Josh2Controls 1.inputactions
//
...
public partial class @Josh2Controls1: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @Josh2Controls1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""Josh2Controls 1"",
    ""maps"": [
        {
            ""name"": ""Josh2"",
    ...
    {
        private @Josh2Controls1 m_Wrapper;
        public Josh2Actions(@Josh2Controls1 wrapper) { m_Wrapper = wrapper; }
