...
//     version 1.7.0
//     from Assets/josh/dariusControls.inputactions
//
...
public partial class @DariusControls: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @DariusControls()
    {
    ...
    {
        private @DariusControls m_Wrapper;
        public Josh2Actions(@DariusControls wrapper) { m_Wrapper = wrapper; }
