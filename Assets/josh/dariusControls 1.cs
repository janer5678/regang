...
//     version 1.7.0
//     from Assets/josh/dariusControls 1.inputactions
//
...
public partial class @DariusControls1: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @DariusControls1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""dariusControls 1"",
    ""maps"": [
        {
            ""name"": ""Josh2"",
    ...
    {
        private @DariusControls1 m_Wrapper;
        public Josh2Actions(@DariusControls1 wrapper) { m_Wrapper = wrapper; }
