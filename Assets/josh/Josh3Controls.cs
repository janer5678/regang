...
//     version 1.7.0
//     from Assets/josh/Josh3Controls.inputactions
//
...
public partial class @Josh3Controls: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @Josh3Controls()
    {
    ...
    {
        private @Josh3Controls m_Wrapper;
        public Josh2Actions(@Josh3Controls wrapper) { m_Wrapper = wrapper; }
