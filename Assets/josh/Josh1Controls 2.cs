...
//     version 1.7.0
//     from Assets/josh/Josh1Controls 2.inputactions
//
...
public partial class @Josh1Controls2: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @Josh1Controls2()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""Josh1Controls 2"",
    ""maps"": [
        {
            ""name"": ""Josh2"",
    ...
    {
        private @Josh1Controls2 m_Wrapper;
        public Josh2Actions(@Josh1Controls2 wrapper) { m_Wrapper = wrapper; }
