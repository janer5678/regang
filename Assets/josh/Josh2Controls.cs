...
//     version 1.7.0
//     from Assets/josh/Josh2Controls.inputactions
//
...
public partial class @Josh2Controls: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @Josh2Controls()
    {
    ...
    {
        private @Josh2Controls m_Wrapper;
        public Josh2Actions(@Josh2Controls wrapper) { m_Wrapper = wrapper; }
